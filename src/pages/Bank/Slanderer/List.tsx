...
type Props = {
  item: TSingleSlanderer;
  handleModal: Function;
  setSelectedSlanderer: Function;
};

const SlandererList = ({ item, handleModal, setSelectedSlanderer }: Props) => {
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col gap-1">
          <div className=" flex gap-2">
            <span className="family-bold">{item.slanderer_name}</span>
